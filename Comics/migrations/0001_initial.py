# Generated by Django 4.1.3 on 2023-02-06 05:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Manhwa', 'Manhwa'), ('Manhua', 'Manhua')], default='Manhwa', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Chapter',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_urls', models.URLField(blank=True, max_length=100000)),
                ('image', models.ImageField(blank=True, max_length=100000, upload_to=Comics.models.comics_images_location)),
                ...
                ('numChapters', models.IntegerField(blank=True, default=0)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(default=django.utils.timezone.now)),
                ('like_count', models.BigIntegerField(blank=True, default=0)),
                ('category', models.ForeignKey(blank='False', null=True, on_delete=django.db.models.deletion.SET_NULL, to='Comics.categorys')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, max_length=100000, upload_to=Comics.models.comics_chapters_images_location)),
        ...
        migrations.AddField(
            model_name='comic',
            name='genres',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Comics.genre'),
        ),
        migrations.AddField(
            model_name='comic',
            name='likes',
